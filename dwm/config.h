...
static const char *bitwarden[] = {"st", "rofi-rbw", NULL};
static const Key keys[] = {
    ...
    {MODKEY | Mod1Mask, XK_c, spawn, {.v = ranger}},
    {MODKEY | ControlMask, XK_x, spawn, {.v = network}},
    {MODKEY | ControlMask, XK_z, spawn, {.v = bitwarden}},
